...
export default function TrueNorthLanding() {
  return (
    <div className="relative min-h-screen text-slate-900">
      ...
      {/* <div className="pointer-events-none fixed inset-0 -z-30 bg-gradient-to-br from-sky-100 via-slate-100 to-emerald-100" /> */}

      {/* Soft blurred color layer */}
      {/* <div className="pointer-events-none fixed inset-0 -z-20 overflow-hidden">
        <div className="absolute -top-24 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-blue-200/45 blur-3xl" />
        <div className="absolute top-28 left-8 h-64 w-64 rounded-full bg-sky-200/35 blur-3xl" />
        <div className="absolute bottom-10 right-10 h-80 w-80 rounded-full bg-emerald-200/40 blur-3xl" />
      </div> */}
        ...
        <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/88 backdrop-blur">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
            <div className="flex items-center gap-3">
              <div className="grid h-20 w-20 place-items-center rounded-xl">
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-3">
                  ...
                  <div className="flex items-center gap-3 text-sm text-slate-700">
                    ...
                    <span>truenorthrisingsc@gmail.com</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-slate-700">
                    <MapPin className="h-4 w-4 text-slate-600" />
                    <span>Coastal Southern California</span>
                  </div>
                </div>
              </CardContent>
            </Card>
